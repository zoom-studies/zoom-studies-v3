...
class App extends Component {
  ...
  constructor(props) {
    ...
    const questions = {
      'control': docArray.slice(docArray.length / 2, docArray.length),
      'codebook': docArray.slice(0, docArray.length / 2)
    };
  ...
  finishExperiment() {
    ...
    const sheet0row = {Worker_ID: workerID,	u_ID: uID, starts_with: 'control', consent_signed: consentSigned,	generated_code: code};
